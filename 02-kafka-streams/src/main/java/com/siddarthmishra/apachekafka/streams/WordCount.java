...
public class WordCount {
	...
	public static void main(String[] args) {
		...
		builder.<String, String>stream(CommonConstants.TOPIC_STREAMS_WORDCOUNT_INPUT)
				.flatMapValues(value -> Arrays.asList(value.toLowerCase(Locale.getDefault()).split("\\W+")))
				.groupBy((key, value) -> value)
				.count(Materialized.<String, Long, KeyValueStore<Bytes, byte[]>>as("counts-store")).toStream()
				.to(CommonConstants.TOPIC_STREAMS_WORDCOUNT_OUTPUT, Produced.with(Serdes.String(), Serdes.Long()));
